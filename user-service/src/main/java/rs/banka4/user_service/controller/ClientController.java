...
public class ClientController {
    ...
    public ResponseEntity<Page<ClientDto>> getClients(
            ...
            @RequestParam(required = false) @Parameter(description = "Phone of the client") String phone,
        ...
        return clientService.getAll(firstName, lastName, email, phone, sortBy, PageRequest.of(page, size));
    }
